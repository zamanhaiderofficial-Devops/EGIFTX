...
export default function Hero({isDark,setIsDark}) {
  ...
  return (
    <div>
      <section className=''>
        <div className={`relative bg-cover bg-no-repeat bg-center rounded-bl-4xl rounded-br-4xl ${
          isDark ?
          ...
          <div className='max-w-360 mx-auto'>
            ...
            <div className={`fixed top-0 right-0 pb-4 left-0 z-40 bg-linear-to-r from-[#504af1] via-[#855ed1] to-[#f1afe4] rounded-bl-2xl rounded-br-2xl transition-all duration-300 ${
              scroll ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"
            }`}>
        ...
        ${toggle ? "right-0" : "-right-2000 transition-all duration-300"}`}> 
      ...
      {/* Fixed bottom bar for mobile - MOVED OUTSIDE THE SECTION */}
